    ...
    <View style={[styles.inputContainer, { flex }]}>
      ...
      <TextInput
        style={[
          ...
          error && { borderColor: '#FF3B30', borderWidth: 2 },
          isFocused && { borderColor: '#FF77A9', borderWidth: 2 }
        ]}
...
const DropdownSelector = ({ label, options, selectedValue, onSelect, error, required, flex = 1, suffix = "", placeholder = "選択 ▼" }) => {
  ...
  return (
    <View style={[styles.inputContainer, { flex }]}>
      ...
      <TouchableOpacity 
        style={[styles.dropdownTrigger, error && { borderColor: '#FF3B30', borderWidth: 2 }]} 
